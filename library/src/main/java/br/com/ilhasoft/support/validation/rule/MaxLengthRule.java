 ...
 */
public class MaxLengthRule extends OptionalRule<TextView, Integer> {

    public MaxLengthRule(TextView view, Integer value, String errorMessage, boolean allowEmpty) {
